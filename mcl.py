...
class MCL(object):
    ...
    def publish_laser_pts(self, msg):
        ...
        pts_in_map = [ (x + r*mt.cos(theta + yaw_in_map),
                        y + r*mt.sin(theta + yaw_in_map),
    ...
    def get_particle_marker(self, timestamp, particle, marker_id):
        ...
        msg.points.append(Point(particle.pos[0], particle.pos[1], 0.2))
        msg.points.append(Point(particle.pos[0] + 0.3*vx, particle.pos[1] + 0.3*vy, 0.2))
